...
/**
 * Wrap multer middleware to handle errors properly for customer portal
 ...
 */
router.post('/trips/:id/documents', authenticateCustomer, uploadWithErrorHandling, (req, res) => {
  try {
    const db = getDb();
    const tripId = req.params.id;
