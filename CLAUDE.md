...
This command **requires** the project directory as an argument via `/Users/georgesmacbook/atlas`.

**Example:** `/create-spec generations/my-app`

**Output location:** `/Users/georgesmacbook/atlas/.autoforge/prompts/app_spec.txt` and `/Users/georgesmacbook/atlas/.autoforge/prompts/initializer_prompt.md`

If `/Users/georgesmacbook/atlas` is empty, inform the user they must provide a project path and exit.
...
The output directory is: `/Users/georgesmacbook/atlas/.autoforge/prompts/`

Once the user approves, generate these files:

## 1. Generate `app_spec.txt`

**Output path:** `/Users/georgesmacbook/atlas/.autoforge/prompts/app_spec.txt`
...
**Output path:** `/Users/georgesmacbook/atlas/.autoforge/prompts/initializer_prompt.md`
...
**Output path:** `/Users/georgesmacbook/atlas/.autoforge/prompts/.spec_status.json`
...
> "Your specification files have been created in `/Users/georgesmacbook/atlas/.autoforge/prompts/`!
>
> **Files created:**
> - `/Users/georgesmacbook/atlas/.autoforge/prompts/app_spec.txt`
> - `/Users/georgesmacbook/atlas/.autoforge/prompts/initializer_prompt.md`
>
